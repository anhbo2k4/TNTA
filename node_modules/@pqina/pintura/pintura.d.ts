...
export interface CropPluginOptions {
    ...
    /** Format preset select icon */
    cropFormatIconSelectPreset?: (
...
export interface PinturaMarkupEditorProperties {
     ...
     */
    markupEditorToolShareStyles?: boolean;
...
export interface PinturaEditorImageOptions {
    ...
    imageColorMatrix?: { [key: string]: ColorMatrix };
...
export interface PinturaEditorBaseOptions {
    ...
    /** Used to format loading status */
    formatStatusImageLoading?: (values: { state: any }, locale?: any) => string;

    /** Used to format processing status */
    formatStatusImageProcessing?: (values: { state: any }, locale?: any) => string;

    /** Used to format support error status */
    formatStatusSupportError?: (
        values: { features: string[] },
        locale?: any
    ) => {
        [key: string]: string;
    };
